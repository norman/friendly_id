...
module FriendlyId
  ...
  module Slugged
    ...
    #     end
    #
    # {FriendlyId::Normalizers::Babosa} transliterates Cyrillic, Greek,
    ...
    def normalize_friendly_id(value)
      ...
      # so a model configured with `sequence_separator = ":"` still produces
      # "hello-world" and then "hello-world:2".
    ...
    module Configuration
      ...
      #
      # Defaults to {FriendlyId::Normalizers::ActiveSupport}, which is
      # `String#parameterize`. Overriding `normalize_friendly_id` in the model
      # bypasses this entirely and remains the primary extension point.
      # @return [#call] The normalizer. Defaults to the Active Support one.
      def normalizer
